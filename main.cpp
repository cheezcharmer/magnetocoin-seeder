...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Magnetocoin-seeder\n"
...
static const string mainnet_seeds[] = {"magnetoseeder.magnetocoin.com", ""};
static const string testnet_seeds[] = {"magnetotestnet.magnetocoin.com", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 9550), true);
  }
  do {
